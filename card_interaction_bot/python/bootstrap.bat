...
IF ERRORLEVEL 1 (
    ...
    echo Python 已安装，版本:!python_version! / Python is already installed, version: !python_version!
)
...
IF ERRORLEVEL 1 (
    ...
    echo pip 已安装，版本: %pip_version% / pip is already installed, version: %pip_version%
)
